...
public class MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (kanjiRepository.getAllKanjis().isEmpty() && kanaRepo.getAllKanas().isEmpty()) {
            loadData();
        }
    ...
    public void loadKanjis() {
        ...
        String[] allKanjis = loadDataFromCsv("allkanji.csv");
        KanjiDb kanjiDb;
        ...
        for (String kanji : kanjilvl7) {
            kanjiDb = new KanjiDb(kanji);
            kanjiDb.setLevel("7");
            kanjiRepository.insert(kanjiDb);
        }

        for (String kanji : allKanjis) {
            kanjiDb = new KanjiDb(kanji);
            kanjiDb.setLevel("8");
            kanjiRepository.insert(kanjiDb);
        }
