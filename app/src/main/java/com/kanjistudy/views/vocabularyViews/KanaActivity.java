...
public class KanaActivity extends FragmentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.bottom_bar_quiz:
                        Intent fromKanaToQuizMenuIntentBottom = new Intent(KanaActivity.this, QuizActivity.class);
        ...
        if (type.equals("hiragana")) {
            kanaTypeDescriptionTextView.setText(R.string.hiragana_dictionary);
        } else {
            kanaTypeDescriptionTextView.setText(R.string.katakana_dictionary);
        }
